//! RPC interface for the custom Jungochain rpc methods
...
pub use jungochain_custom_rpc_runtime_api::{
    DelegateInfoRuntimeApi, NeuronInfoRuntimeApi, SubnetInfoRuntimeApi,
    SubnetRegistrationRuntimeApi,
};

#[rpc(client, server)]
pub trait JungochainCustomApi<BlockHash> {
...
pub struct JungochainCustom<C, P> {
    /// Shared reference to the client.
    client: Arc<C>,
    _marker: std::marker::PhantomData<P>,
}

impl<C, P> JungochainCustom<C, P> {
...
impl<C, Block> JungochainCustomApiServer<<Block as BlockT>::Hash> for JungochainCustom<C, Block>
where
    Block: BlockT,
